...
namespace TodoApp.Data.Repositories
{
    public class ItemRepository:IItemRepository
    {
        ...
        public IEnumerable<Item> GetAll() => ItemList;

        public Item Get(Guid id) => ItemList[0];

        public Item Add(Item item) => ItemList[0];

        public Item Update(Guid id, Item item) => ItemList[0];
